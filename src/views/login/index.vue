  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on"
      ...
      <el-form-item prop="username">
        ...
        <el-input ref="username" v-model="loginForm.username" placeholder="用户名Username" name="username" type="text"
      ...
      <el-form-item prop="password">
        ...
        <el-input :key="passwordType" ref="password" v-model="loginForm.password" :type="passwordType"
          placeholder="密码Password" name="password" tabindex="2" auto-complete="on" @keyup.enter.native="handleLogin" />
...
<style lang="scss">
  ...
  .login-container {
    background-image: "../../assets/login-bg.jpeg";
