<template>
  <div class="container">
    <div class="wrapper">
      <el-form ref="uploadPaper" :model="uploadPaper" label-width="120px">
        <el-form-item label="学号" prop="fileName">
          <el-input v-model="uploadPaper.fileName"></el-input>
        </el-form-item>
        <el-form-item label="文件类型" prop="fileType">
          <el-radio-group v-model="uploadPaper.fileType">
            <el-radio label="0">论文</el-radio>
            <el-radio label="1">作业</el-radio>
            <el-radio label="2">项目文件</el-radio>
          </el-radio-group>
        </el-form-item>
        <div v-if="uploadPaper.fileType == '0' || uploadPaper.fileType == '1'">
          <el-form-item label="所属科目" prop="subject">
            <el-select v-model="uploadPaper.subject" placeholder="请选择">
        ...
        <div v-else>
          <el-form-item label="项目类名" prop="catag">
            <el-select v-model="uploadPaper.catag" placeholder="请选择">
        ...
        <el-form-item>
          ...
          <el-button @click="resetForm('uploadPaper')">重置</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
...
export default {
  ...
  methods: {
    onSubmit() {
      this.$message("submit");
      console.log(this.$data.uploadPaper);

    },
    resetForm(uploadPaper) {
      console.log("reset");
      this.$refs[uploadPaper].resetFields();
    },
